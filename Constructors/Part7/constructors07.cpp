/*************************************************************
*  Name:           constructors07(Date05)
*  Author:         Greg Korte
*  Date due:       15-10-19
*  Description:    Create a date class with getters and setters.
                   Create two constructors (one default), one copy
                   constructor and one destructor. Create function
                   to check leap year. Create a function to
                   calculate the Julian day of the year. Create a
                   function to test copy constructor. Test output
